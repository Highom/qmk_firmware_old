...
enum alt_keycodes {
    ...
    L_T_GCM,            //LED Toggle Game Color Modjje
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [1] = LAYOUT(
        ...
        _______,  _______, _______,                              KC_MPLY,                            KC_RCTL, _______, KC_F13,  KC_F14,  KC_F15  \
    ),
    /*
    [X] = LAYOUT(
...
void *led_instruction_list[] = {
    ...
    led_instructions_pleasuretek   //6
};
